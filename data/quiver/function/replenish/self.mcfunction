function quiver:_schedule/c4436c93-b339-4e5e-9007-64bfb11aa1d3
...
execute if score @s quiver.count.arrow matches ..61 run data modify entity @n[tag=quiver.item] Item.components."minecraft:damage" set value 75
execute if score @s quiver.count.arrow matches 62..125 run data modify entity @n[tag=quiver.item] Item.components."minecraft:damage" set value 50
execute if score @s quiver.count.arrow matches 126..188 run data modify entity @n[tag=quiver.item] Item.components."minecraft:damage" set value 30
execute if score @s quiver.count.arrow matches 189.. run data modify entity @n[tag=quiver.item] Item.components."minecraft:damage" set value 1
