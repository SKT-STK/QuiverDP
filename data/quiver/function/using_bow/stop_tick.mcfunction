...
item modify entity @s weapon.mainhand [{function:"set_components",components:{"!minecraft:enchantment_glint_override":{},"!minecraft:rarity":{}}},{function:"set_enchantments",enchantments:{"quiver:quiver":0}}]
